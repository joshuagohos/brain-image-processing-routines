...
% 2022/07 Hannah created for denosing process (Compcor,detrend, bandpass & grey matter
% masking) for AXC RES-FC analysis

clear;clc 

PATH_AXC_RES_TW_Nifti='/bml/Data/Bank1/AXC_RES/TW/Nifti/'; 
PATH_AXC_RES_US_Nifti='/bml/Data/Bank1/AXC_RES/US/'; 
for subj =  2
    EPI = {};   
    for run =1
       for vol_RES = 1:626
           EPI{1,run}(vol_RES,1) = {[PATH_AXC_RES_TW_Nifti 'sub-' num2str(subj) '/func/REST' ...
                '/abuRsub-' num2str(subj) '_REST_acq-EPI_bold.nii,' num2str(vol_RES)]};      
...
save(['sub-' num2str(subj) '_denoise.mat'], 'matlabbatch')
